...
int Single_Socket()
{
    ...
    if (prog_options.arch == SANDY_BRIDGE)
        printf("i7z DEBUG: guessing Sandy Bridge\n\r");
    else if (prog_options.arch == IVY_BRIDGE)
        printf("i7z DEBUG: guessing Ivy Bridge\n\r");
    else if (prog_options.arch == HASWELL)
        printf("i7z DEBUG: guessing Haswell\n\r");
    else if (prog_options.arch == BROADWELL)
        printf("i7z DEBUG: guessing Broadwell\n\r");
    else if (prog_options.arch == SKYLAKE)
        printf("i7z DEBUG: guessing Skylake\n\r");
    else if (prog_options.arch == KABY_LAKE)
        printf("i7z DEBUG: guessing Kaby Lake\n\r");
    else 
        printf("i7z DEBUG: %i\n", &prog_options);
        printf("i7z DEBUG: guessing not working... %i\n\r", &prog_options.arch);
